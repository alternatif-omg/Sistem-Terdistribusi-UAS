...
INSERT INTO `attendance` (`attendance_id`, `student_id`, `activity_id`, `attendance_date`, `status`, `check_in_time`, `notes`) VALUES
(1, 22010001, 1, '2024-11-10', 'hadir', '14:00:00', '');
...
CREATE TABLE `registrations` (
  ...
  `confirmation_status` enum('berhasil','tertunda') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `registrations` (`registration_id`, `student_id`, `activity_id`, `registration_date`, `position`, `registration_fee`, `confirmation_status`) VALUES
(1, 22010001, 1, '2024-11-09', 'Anggota', '0', 'berhasil');
